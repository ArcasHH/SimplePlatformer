...
void PushButton::input(const sf::RenderWindow& window, const sf::View& view) {
...
bool PushButton::is_pos(const sf::RenderWindow& window, const sf::View &view) const { // function: bool is mouse is possed at button rect
